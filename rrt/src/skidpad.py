...
class planner:
    ...
    def hor_dist(self,point1,point2):#on y
       xx= point1-point2
       if(xx>0):
             return xx
       else:
          ...
          for pt1,pt2 in newlist_y:#gets the cones as tupels
                ...
                if(self.initialset):
                   if(self.distance_coordinate[-1]>=self.distance_coordinate[-2] and self.txt == 0): #or (self.firstwarningdetect == 0)):
                        ...
                        self.circle_right_y = pointmid[1] + (1.5 + (15.25/2))
                        self.circle_right_x = pointmid[0] + 2
                        self.circle_left_x = pointmid[0]  + 2
                        self.circle_left_y = pointmid[1] - (1.5+(15.25/2)) 
